...
<h1 class="text-center" id="system_name"><?= $_settings->info('name') ?></h1>
  <div class="clear-fix my-2">
    
  <a href="./vendor" class="btn btn-primary btn-block btn-flat">Shop Login</a>
  </div>
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h2 text-decoration-none"><b>Customer Login</b></a>
    </div>
    <div class="card-body">
