            ...
            <div class="row">
                ...
                ?>
                    ...
                    <?php endwhile; ?> <br>
                        ...
                        <input type="radio" name="mode_of_payment" value="Cash" id="cash">Cash
                        <input type="radio" name="mode_of_payment" value="Gcash" id="gcash">Gcash
                        <input type="radio" name="mode_of_payment" value="Bank" id="bank">Bank
                        <br>
