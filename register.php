...
<body class="hold-transition">
  ...
  <!--      </div>-->
  <!--      <div class="col-6 h-100 bg-gradient-light px-5">-->
    <center><img src="<?= validate_image($_settings->info('logo')) ?>" alt="System Logo" class="img-thumbnail rounded-circle" id="logo-img"></center>
<h1 class="text-center" id="system_name"><?= $_settings->info('name') ?></h1>

<div class="login-box" style="width:100%;">
  
            <div class="d-flex justify-content-center align-items-center w-100 h-200">
              <div class="card card-outline card-primary col-md-50 col-lg-100 rounded-5 shadow" style="max-width: 96%;">
