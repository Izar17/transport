...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT * from `driver_list` where id = '{$_GET['id']}' and delete_flag = 0 ");
    if($qry->num_rows > 0){
...
<div class="container-fluid">
	<form action="" id="driver-form">
		...
		<div class="form-group">
			...
			<textarea name="description" id="description" class="summernote form-control form-control-sm form-control-border" required><?php echo isset($description) ? $description : ''; ?></textarea>
		</div>
		<div class="form-group">
...
<script>
	...
	$(document).ready(function(){
		$('#uni_modal #driver-form').submit(function(e){
			e.preventDefault();
            var _this = $(this)
			 $('.err-msg').remove();
