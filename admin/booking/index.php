        ...
        <div class="row">
            ...
            <div class="col-md-2 d-flex flex-column" style="border: 1px solid #000; border-radius:10px; padding: 10px; margin-top: -55px;background-color:#D4FEFD;">
				...
				<table style="width:100%;font-size:14px;padding:0px;font-weight:bold;">
					...
					<!-- Terminal Fee -->
                    <label><input type="checkbox" id="chkTerminalFee" value="yes" <?php echo isset($meta['terminal_fee']) ? 'checked': '' ?>> &nbsp; Terminal Fee:&nbsp</label><label id="lblTerminalFee"> 0.00</label>
					...
					<!-- Environment Fee -->
                    <label><input type="checkbox" id="chkEnvFee" value="yes" <?php echo isset($meta['environment_fee']) ? 'checked': '' ?>> &nbsp; Environment Fee:&nbsp</label> <label id="lblEnvFee"> 0.00</label>
