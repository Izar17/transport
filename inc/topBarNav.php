      ...
      <nav class="w-100 px-2 py-1 position-fixed top-0 bg-dark text-light" id="login-nav">
        <div class="d-flex justify-content-between w-100">
          ...
          <div>
            ...
            <?php else: ?>
              <a href="./admin" class="mx-2 text-light text-decoration-none font-weight-bolder">Login</a> 
              <!-- <a href="./login.php" class="mx-2 text-light text-decoration-none font-weight-bolder">Login</a> | 
              <a href="./vendor" class="mx-2 text-light text-decoration-none font-weight-bolder">Motorshop Login</a> | 
...
// Check if user is logged in
              ...
              <li class="nav-item">
                <a href="./?page=orders/my_orders" class="nav-link <?= isset($page) && $page =='orders/my_orders' ? "active" : "" ?>">My Order</a>
              </li>
              <?php endif; ?>
            </ul>
          </div>
