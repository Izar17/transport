					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<div id="map"></div> <br>
								...
								<input type="text" id="latitude" name="lat"  value="<?= isset($lat) ? $lat : "" ?>" readonly>
								<label for="longitude">Longitude:</label>
								<input type="text" id="longitude" name="lng" value="<?= isset($lng) ? $lng : "" ?>" readonly>
								<label for="color">Choose a marker color:</label>
								<input type="color" id="color" name="marker_color" oninput="updateColorValue()" value="<?= isset($marker_color) ? $marker_color : "" ?>">
								<span id="colorValue">#000000</span>
						</div>
						<div class="form-group col-md-6">
							<label for="address" class="control-label">Address</label>
							<input type="text" id="address" autofocus name="address" class="form-control form-control-sm form-control-border" value="<?= isset($address) ? $address : "" ?>" required>
							<br>
...
<script>
    window.onload = function() {
        function initMap() {
            ...
            const markerColor = document.getElementById("color").value;
            const shopName = document.getElementById("shop_name").value;
            
            const map = new google.maps.Map(document.getElementById("map"), {
                zoom: 15,
                center: {lat: 14.038413, lng: 120.654508}
            });
            ...
            map.addListener("click", (e) => {
                ...
                document.getElementById("shop_name").value = latLng.shopName();
            });
        }
