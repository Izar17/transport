      ...
      <nav class="main-header navbar navbar-expand navbar-light text-sm shadow">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url ?>" class="nav-link"><?php echo (!isMobileDevice()) ? $_settings->info('name'):$_settings->info('short_name'); ?> - <?php echo ucwords($_settings->userdata('shop_name')) ?> </a>
          </li>
        </ul>
        <!-- Right navbar links -->
