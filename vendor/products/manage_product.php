	...
	<form action="" id="product-form">
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<input name="quantity" id="quantity" type="number" step="any" class="form-control form-control-sm form-control-border" value="<?php echo isset($quantity) ? $quantity : ''; ?>" required>
