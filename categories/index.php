...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal('Add New Category',"categories/manage_category.php",'large')
		})
		$('.view_data').click(function(){
			uni_modal('View Category Details',"categories/view_category.php?id="+$(this).attr('data-id'),'large')
		})
		$('.edit_data').click(function(){
			uni_modal('Update Category',"categories/manage_category.php?id="+$(this).attr('data-id'),'large')
		})
